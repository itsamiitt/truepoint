// ProviderConfigsPage — enrichment providers with key hints, rate limits, monthly budget and month-to-date spend, and health.
//
...
import { ProviderConfigsPage } from "@leadwolf/ui";
import { Page } from "./_appPage";

/** Provider configs with the console's data loaded. */
export const Loaded = () => (
  <Page height={760}>
    <ProviderConfigsPage />
  </Page>
