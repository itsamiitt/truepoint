// ProfilePanel - Settings ▸ User ▸ Profile (12 §2): name / avatar preview / timezone / locale, saved via PATCH /settings/user/profile.
//
...
import { ProfilePanel } from "@leadwolf/ui";
import { Page } from "./_webPage";

/** ProfilePanel with the workspace's data loaded. */
export const Loaded = () => (
  <Page height={700}>
    <ProfilePanel />
  </Page>
