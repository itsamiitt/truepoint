// SalesNavPage - composes the Sales Navigator capture surface (05 §5, M7): the capture form above, the workspace's captured links below.
//
...
import { SalesNavPage } from "@leadwolf/ui";
import { Page } from "./_webPage";

/** SalesNavPage with the workspace's data loaded. */
export const Loaded = () => (
  <Page height={1000}>
    <SalesNavPage />
  </Page>
