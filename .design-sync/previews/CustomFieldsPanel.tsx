// CustomFieldsPanel - Workspace ▸ Custom fields settings (ADR-0028, gap G-REV-5).
//
...
import { CustomFieldsPanel } from "@leadwolf/ui";
import { Page } from "./_webPage";

/** CustomFieldsPanel with the workspace's data loaded. */
export const Loaded = () => (
  <Page height={700}>
    <CustomFieldsPanel />
  </Page>
