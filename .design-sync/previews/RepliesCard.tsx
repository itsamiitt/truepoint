// RepliesCard - recent replies across email and LinkedIn.
//
...
import { RepliesCard } from "@leadwolf/ui";
...
export const Loaded = () => (
  <Frame>
    <RepliesCard replies={D.W.HOME_SUMMARY.recentReplies} {...D.idle} />
  </Frame>
);
