// TasksCard - today's tasks on Home, by kind and due time.
//
...
import { TasksCard } from "@leadwolf/ui";
...
export const Loaded = () => (
  <Frame>
    <TasksCard tasks={D.W.HOME_SUMMARY.todaysTasks} {...D.idle} />
  </Frame>
);
