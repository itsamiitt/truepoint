// RecentImportsCard - the most recent imports into this workspace, with row counts.
//
...
import { RecentImportsCard } from "@leadwolf/ui";
...
export const Loaded = () => (
  <Frame>
    <RecentImportsCard imports={D.W.HOME_SUMMARY.recentImports} {...D.idle} />
  </Frame>
);
...
export const Empty = () => (
  <Frame>
    <RecentImportsCard imports={[]} {...D.idle} />
  </Frame>
);
...
export const Loading = () => (
  <Frame>
    <RecentImportsCard imports={[]} {...D.busy} />
  </Frame>
);
...
export const Failed = () => (
  <Frame>
    <RecentImportsCard imports={[]} {...D.failed} />
  </Frame>
);
