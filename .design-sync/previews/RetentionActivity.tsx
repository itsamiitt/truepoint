// RetentionActivity - what the retention engine did on its last passes. A shadow run counts candidates and deletes nothing.
//
...
import { RetentionActivity } from "@leadwolf/ui";
...
export const Loaded = () => (
  <Frame>
    <RetentionActivity runs={D.W.RETENTION_RUNS_WEB} {...D.idle} />
  </Frame>
);
...
export const Failed = () => (
  <Frame>
    <RetentionActivity runs={[]} {...D.failed} />
  </Frame>
);
