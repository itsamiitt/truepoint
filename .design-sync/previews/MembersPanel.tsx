// MembersPanel - Workspace ▸ Members & roles: an invite row + a members DataTable with inline role changes and a remove confirmation Dialog.
//
...
import { MembersPanel } from "@leadwolf/ui";
import { Page } from "./_webPage";

/** MembersPanel with the workspace's data loaded. */
export const Loaded = () => (
  <Page height={700}>
    <MembersPanel />
  </Page>
