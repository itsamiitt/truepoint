// DataHealthCard - the Home data-health widget: coverage, validity and freshness for this workspace.
//
...
import { DataHealthCard } from "@leadwolf/ui";
...
export const Loaded = () => (
  <Frame>
    <DataHealthCard metrics={D.W.DATA_QUALITY} {...D.idle} />
  </Frame>
);
...
export const Empty = () => (
  <Frame>
    <DataHealthCard metrics={null} {...D.idle} />
  </Frame>
);
...
export const Loading = () => (
  <Frame>
    <DataHealthCard metrics={null} {...D.busy} />
  </Frame>
);
...
export const Failed = () => (
  <Frame>
    <DataHealthCard metrics={null} {...D.failed} />
  </Frame>
);
