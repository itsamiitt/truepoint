// SourceCoverageSection - multi-source coverage over time — how many contacts more than one source vouches for.
//
...
import { SourceCoverageSection } from "@leadwolf/ui";
...
export const Loaded = () => (
  <Frame>
    <SourceCoverageSection trend={D.W.DATA_QUALITY_HISTORY} {...D.idle} />
  </Frame>
);
...
export const Empty = () => (
  <Frame>
    <SourceCoverageSection trend={[]} {...D.idle} />
  </Frame>
);
...
export const Loading = () => (
  <Frame>
    <SourceCoverageSection trend={[]} {...D.busy} />
  </Frame>
);
...
export const Failed = () => (
  <Frame>
    <SourceCoverageSection trend={[]} {...D.failed} />
  </Frame>
);
