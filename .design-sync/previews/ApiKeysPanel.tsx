// ApiKeysPanel - Developer ▸ API keys: a DataTable of tenant-scoped keys (name · scopes · last used · created) with create / rotate / revoke via Dialog + useToast.
//
...
import { ApiKeysPanel } from "@leadwolf/ui";
import { Page } from "./_webPage";

/** ApiKeysPanel with the workspace's data loaded. */
export const Loaded = () => (
  <Page height={700}>
    <ApiKeysPanel />
  </Page>
