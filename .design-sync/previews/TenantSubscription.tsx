// TenantSubscription — the current plan, term, renewal date and auto-renew state.
//
...
import { TenantSubscription } from "@leadwolf/ui";
import { Page } from "./_appPage";

const TENANT_ID = "00000000-0000-4000-8000-000000000101";

/** Subscription for a live tenant. */
export const Loaded = () => (
  <Page height={380}>
    <TenantSubscription tenantId={TENANT_ID} />
  </Page>
);
