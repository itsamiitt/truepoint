// DataHealthSection - the Reports data-health section: the email-status distribution behind the headline validity number.
//
...
import { DataHealthSection } from "@leadwolf/ui";
...
export const Loaded = () => (
  <Frame>
    <DataHealthSection rollup={D.DATA_HEALTH_ROLLUP} {...D.idle} />
  </Frame>
);
...
export const Empty = () => (
  <Frame>
    <DataHealthSection rollup={null} {...D.idle} />
  </Frame>
);
...
export const Loading = () => (
  <Frame>
    <DataHealthSection rollup={null} {...D.busy} />
  </Frame>
);
...
export const Failed = () => (
  <Frame>
    <DataHealthSection rollup={null} {...D.failed} />
  </Frame>
);
