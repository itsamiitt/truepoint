// PricingPage — the credit-pack catalogue staff maintain, including a retired pack.
//
...
import { PricingPage } from "@leadwolf/ui";
import { Page } from "./_appPage";

/** Pricing with the console's data loaded. */
export const Loaded = () => (
  <Page height={760}>
    <PricingPage />
  </Page>
