// TeamsPanel - Settings ▸ Workspace ▸ Teams (Part D, decision #6): create/delete teams and manage each team's member roster.
//
...
import { TeamsPanel } from "@leadwolf/ui";
import { Page } from "./_webPage";

/** TeamsPanel with the workspace's data loaded. */
export const Loaded = () => (
  <Page height={700}>
    <TeamsPanel />
  </Page>
