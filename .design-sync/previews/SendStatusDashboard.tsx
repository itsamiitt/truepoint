// SendStatusDashboard - the send funnel for one sequence: sent, opened, clicked, replied and bounced, each as a share of sent.
//
...
import { SendStatusDashboard } from "@leadwolf/ui";
...
export const Loaded = () => (
  <Frame>
    <SendStatusDashboard sequences={D.W.SEQUENCES.sequences} {...D.idle} />
  </Frame>
);
...
export const Empty = () => (
  <Frame>
    <SendStatusDashboard sequences={[]} {...D.idle} />
  </Frame>
);
...
export const Loading = () => (
  <Frame>
    <SendStatusDashboard sequences={[]} {...D.busy} />
  </Frame>
);
...
export const Failed = () => (
  <Frame>
    <SendStatusDashboard sequences={[]} {...D.failed} />
  </Frame>
);
