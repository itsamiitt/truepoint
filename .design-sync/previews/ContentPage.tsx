// ContentPage — in-product announcements: banners and modals, their audience, window and active state.
//
...
import { ContentPage } from "@leadwolf/ui";
import { Page } from "./_appPage";

/** Content with the console's data loaded. */
export const Loaded = () => (
  <Page height={820}>
    <ContentPage />
  </Page>
