// DataQualityPage — the fleet-wide data-health rollup — coverage, email validity and freshness across every workspace — with recent verification runs.
//
...
import { DataQualityPage } from "@leadwolf/ui";
import { Page } from "./_appPage";

/** Data quality with the console's data loaded. */
export const Loaded = () => (
  <Page height={880}>
    <DataQualityPage />
  </Page>
