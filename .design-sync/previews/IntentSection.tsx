// IntentSection - the intent-signals half of the Lead score & intent dashboard.
//
...
import { IntentSection } from "@leadwolf/ui";
import { Page } from "./_webPage";

/** IntentSection with the workspace's data loaded. */
export const Loaded = () => (
  <Page height={700}>
    <IntentSection />
  </Page>
