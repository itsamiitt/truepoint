// DataHealthTrendCard - the data-health trend on Home, from the weekly quality snapshots.
//
...
import { DataHealthTrendCard } from "@leadwolf/ui";
...
export const Loaded = () => (
  <Frame>
    <DataHealthTrendCard trend={D.W.DATA_QUALITY_HISTORY} {...D.idle} />
  </Frame>
);
...
export const Empty = () => (
  <Frame>
    <DataHealthTrendCard trend={[]} {...D.idle} />
  </Frame>
);
...
export const Loading = () => (
  <Frame>
    <DataHealthTrendCard trend={[]} {...D.busy} />
  </Frame>
);
...
export const Failed = () => (
  <Frame>
    <DataHealthTrendCard trend={[]} {...D.failed} />
  </Frame>
);
