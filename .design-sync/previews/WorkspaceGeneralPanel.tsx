// WorkspaceGeneralPanel - the Workspace ▸ General settings form (name / slug / region / timezone).
//
...
import { WorkspaceGeneralPanel } from "@leadwolf/ui";
import { Page } from "./_webPage";

/** WorkspaceGeneralPanel with the workspace's data loaded. */
export const Loaded = () => (
  <Page height={700}>
