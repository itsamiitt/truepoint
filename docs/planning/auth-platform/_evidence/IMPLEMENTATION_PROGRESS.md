...
| Concurrent-session cap (`maxConcurrentSessions`); `__Host-` cookie; @leadwolf/auth-client extract | AUTH-042/074/073 | S–M | ◻ | Remaining Phase-2 items. The concurrent-session cap can ride the Phase-1 effective-policy engine as a new key. |
