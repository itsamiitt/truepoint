...
- **Status:** Accepted
- **Date:** 2026-06-17
- **Context doc:** [07-billing-credits.md](../07-billing-credits.md), [30-bulk-enrichment.md](../30-bulk-enrichment.md), [03-database-design.md](../03-database-design.md)
...
- **Siblings:** [ADR-0036](./ADR-0036-bulk-enrichment-pipeline.md) (the job pipeline this bills), [ADR-0037](./ADR-0037-bulk-enrichment-match-first.md) (the match-first stage whose sample feeds the forecast)

## Context

LeadWolf is adding **bulk CSV enrichment** ([30](../30-bulk-enrichment.md)): a user uploads a sparse CSV,
the rows are matched against our own universe ([ADR-0037](./ADR-0037-bulk-enrichment-match-first.md)) and
...
A bulk enrichment job ([ADR-0036](./ADR-0036-bulk-enrichment-pipeline.md)) bills through **four** rules; all
...
- The match-first stage ([ADR-0037](./ADR-0037-bulk-enrichment-match-first.md)) matches a **sample** of the
...
- The job parks in status **`awaiting_confirmation`** ([ADR-0036](./ADR-0036-bulk-enrichment-pipeline.md)) and
...
- **Mitigation:** forecast accuracy tracked on the economics dashboard ([06 §10](../06-enrichment-engine.md))
  and tuned via sample size ([ADR-0037](./ADR-0037-bulk-enrichment-match-first.md)); caps are plan-driven and
...
- **Schema:** new fields on `enrichment_jobs` — `credit_estimate_micros`, `credit_spent_micros`, `charged_rows`
  ...
  [ADR-0036](./ADR-0036-bulk-enrichment-pipeline.md)). No new billing table — charges flow through existing
...
- **Billing/enrichment docs:** [07 §1/§3/§5](../07-billing-credits.md), [06 §6/§10](../06-enrichment-engine.md),
  [30](../30-bulk-enrichment.md); decision log [00 §7](../00-overview.md).
