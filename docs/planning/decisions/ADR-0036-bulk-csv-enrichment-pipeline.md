# ADR-0036 — Bulk CSV enrichment pipeline (match-first, chunked, async)

- **Status:** Accepted
- **Date:** 2026-06-17
- **Context doc:** [30-bulk-enrichment-pipeline.md](../30-bulk-enrichment-pipeline.md) (lead), [06-enrichment-engine.md](../06-enrichment-engine.md), [03-database-design.md](../03-database-design.md), [09-api-design.md](../09-api-design.md), [18-scalability-performance.md](../18-scalability-performance.md)
...
neither. This is the gap [doc 30](../30-bulk-enrichment-pipeline.md) opens and milestone **M17 — Bulk CSV
Enrichment (enterprise scale)** owns.

## Decision

Adopt a **match-first, chunked, asynchronous bulk-enrichment job model** (detail in
[doc 30](../30-bulk-enrichment-pipeline.md)). A bulk run is a first-class **job**, not a loop over single-reveal:
...
**SLO note.** Throughput, end-to-end completion, and match-rate figures in [doc 30](../30-bulk-enrichment-pipeline.md)
