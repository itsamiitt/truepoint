...
| 49 | **S-C8** (04) | Cache↔child reconcile sweep for the merge-facing invariant (pairs with S-CH5) | none | gated repair verb | §R-P3 | §T-P3: T4 (ruling M3) | — |
| 50 | **S-C6** (04) | Ladder extension: any-value email resolve + phone-signal markers in `findByDedupKeys` + bulk-staging equivalents | none | rides S-CH4's flag | §R-P3 | §T-P3: T7 (ruling M3) | — |
| 51 | **S-C7** (04) | Masked-DTO channel summary + read projection | none | rides S-CH4's flag | §R-P3 | §T-P3: masked-contract test | — |
