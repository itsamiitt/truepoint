// Sidebar.tsx — the Forge operator-console left rail. Mirrors the apps/admin rail chrome (dark text on the
// #f9fafb surface, a single hairline right border, subtle fill + cobalt icon on the active route). A muted
// "Operator console" tag under the brand keeps the operator aware this is the internal capture/parse surface.
"use client";
...
export function Sidebar({
  ...
  return (
    <aside className={`tp-sidebar${isOpen ? " is-open" : ""}`}>
      ...
      <div className="tp-staff-tag">Operator console</div>
