    ...
    <html lang="en">
      <body style={{ margin: 0, background: "#f9fafb" }}>
        ...
        >
          ...
          >
            <p style={{ margin: 0, fontSize: 16, fontWeight: 600 }}>TruePoint Forge</p>
            <h1
              style={{
                margin: "12px 0 0",
                fontSize: 22,
            ...
            <p style={{ margin: "8px 0 0", fontSize: 14, lineHeight: 1.5, color: "#6b7280" }}>
              This console hit an unexpected error and could not finish loading. The failure has
              been reported. Reloading usually clears it.
            </p>
            <button
              type="button"
