...
// left rail (with the session role) + top bar + the routed {children}, and mounts the Cmd/Ctrl-K command
// palette once. The section title is derived from the active route so each destination labels its own top
// bar without prop-drilling. (This replaces the per-page session logic that used to live in app/page.tsx.)
"use client";
