  ...
  return (
    <PageContainer width="default">
      <PageHeader
        ...
        subtitle="A cleaned, verified file for one vertical, delivered as CSV and JSON. No integration, no API key — for teams who want the list rather than the plumbing."
      />
